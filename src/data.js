...
export const regions = [
  ...
  ['he_dong','河东府','prefecture',36,76,40,88,30,345,270,'河东州','饥荒|流民'],
  ['lin_he','临河府','prefecture',55,83,65,39,52,520,275,'临河州','秋试|豪强'],
  ['nan_he','南河府','prefecture',43,68,43,93,37,540,445,'南河州','洪灾|河网'],
  ['bei_zhen','镇北军镇','military',27,81,58,45,51,290,86,'北境','征兵|军营'],
  ['bei_an','北岸府','prefecture',31,56,61,29,49,350,165,'北境','旱灾'],
  ['ning_zhou','宁州府','prefecture',29,61,59,26,54,225,225,'北境','商路'],
  ['yan_men','雁门府','prefecture',20,54,53,38,44,175,120,'北境','关隘'],
  ['qiu_yuan','丘原府','prefecture',24,45,52,55,38,165,325,'河东州','饥荒'],
  ['yun_zhou','云州府','prefecture',39,66,60,39,47,300,365,'河东州','商路'],
  ['dong_cheng','东城府','prefecture',48,79,67,19,57,635,175,'临河州','市集'],
  ['qing_xi','清溪府','prefecture',26,59,69,23,63,665,295,'临河州','河网'],
  ['chang_ping','常平仓','granary',18,71,74,22,66,445,360,'临河州','粮仓'],
  ['xi_du','西渡港','port',22,74,58,32,49,350,470,'南河州','水运'],
  ['nan_du','南渡港','port',30,82,49,72,42,610,525,'南河州','水运|洪灾'],
  ['yu_jiang','玉江府','prefecture',32,64,56,61,45,460,555,'南河州','河网'],
  ['shuang_ling','双岭府','prefecture',21,43,72,27,56,240,490,'南河州','山道'],
  ...
  ['shan_bei','山北府','prefecture',19,48,51,43,40,80,235,'河东州','旱灾'],
  ['qing_guan','青关军镇','military',20,64,57,28,48,720,88,'北境','军营'],
  ['huai_ning','怀宁府','prefecture',28,56,68,41,51,350,590,'南河州','农田'],
  ['feng_yi','丰邑府','prefecture',35,55,73,19,63,535,625,'南河州','农田'],
  ['shang_yuan','上原府','prefecture',25,53,62,36,46,565,70,'临河州','驿路'],
...
export const events = [
 ...
 {id:'flood',turn:0,duration:5,title:'南河洪灾',category:'disaster',regionIds:['nan_he','nan_du','yu_jiang'],text:'南河决堤，城外积水久不退，灾民聚于高地。',effect:'灾患与人群聚集上升，水殇易发。',disaster:22,spread:.18,cost:4,borrowable:true},
 {id:'recruit',turn:0,duration:3,title:'北境征兵',category:'military',regionIds:['bei_zhen','bei_an','ning_zhou'],text:'镇北军扩募新兵，沿途州府连日送人北上。',effect:'军道流动增加。',mobility:17,spread:.2,cost:5,borrowable:true},
 {id:'exam',turn:1,duration:2,title:'秋闱将开',category:'society',regionIds:['lin_he','jing','dong_cheng'],text:'三州士子汇聚临河，客栈已满，寺观借作宿处。',effect:'赴考人流增加，寒疫与赤疮受益。',mobility:25,spread:.28,cost:4,borrowable:true},
 {id:'suppress',turn:2,duration:2,title:'权相压奏',category:'politics',regionIds:['he_dong','jing'],text:'裴阙留中不发河东求援奏折。朝中仍称民间安稳。',effect:'朝警降低，地方应对延迟。',alert:-2,governance:-10},
 ...
 {id:'gentry',turn:4,duration:3,title:'豪强关庄',category:'society',regionIds:['lin_he','qing_xi'],text:'临河崔氏闭庄，逐无粮佃户出门。',effect:'庄内收紧，官道流民增加。',mobility:18,order:-7,spread:.18},
 ...
 {id:'rumor',turn:7,duration:2,title:'井中有鬼',category:'society',regionIds:['nan_he','nan_du'],text:'百姓弃井，争往南河取水。',effect:'河岸聚集上升，水殇更易扩散。',order:-5,spread:.24},
 {id:'lockdown',turn:8,duration:3,title:'临河闭门',category:'epidemic',regionIds:['lin_he'],text:'临河封闭四门，商旅不得进出，城外车马绵延。',effect:'出城流动受阻，城外人群聚集。',mobility:-50,governance:10,alert:3},
...
export const factions = [
 {id:'emperor',name:'皇帝',person:'萧承玦',symbol:'玺'},
 {id:'chancellor',name:'权相',person:'裴阙',symbol:'令'},
 {id:'crown_prince',name:'储君',person:'萧祈安',symbol:'东'},
 {id:'army',name:'边军',person:'霍沉岳',symbol:'戍'},
 {id:'gentry',name:'豪强',person:'临河崔氏',symbol:'庄'},
